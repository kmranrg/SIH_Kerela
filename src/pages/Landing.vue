<template>
  ...
  <v-toolbar>
    ...
    <v-toolbar-title><strong>HOSPITALS</strong></v-toolbar-title>
    <v-spacer></v-spacer>
  ...
  <v-container fluid class="white" >
    ...
    <v-layout row wrap class=" py-4 px-2 text-sm-center" >
      ...
      <v-flex xs12>
        <v-btn label large light >
          Audiology And Speech Therapy
        </v-btn>
        <v-btn label color="error" large dark >
          General Surgery
        </v-btn>
        <v-btn label color="primary" large dark >
          Bone Marrow Transplant
        </v-btn>
        <v-btn label color="warning" large dark >
          Dental Care
        </v-btn>
        <v-btn label color="pink" large dark >
          Dietetics
        </v-btn>
        <v-btn label color="blue" large dark >
          ENT
        </v-btn>
        <v-btn label color="brown" large dark >
          Diabetes & Endocrinology  
        </v-btn>
        <v-btn label color="orange" large dark >
          Eye Care
        </v-btn>
        <v-btn label color="blue-grey" large dark >
          IVF
        </v-btn>
        <v-btn label large dark >
          Internal Medicine
        </v-btn>
        <v-btn label color="deep-orange" large dark >
          Gasteroenterology
        </v-btn>
        <v-btn label color="green" large dark >
          Nephrology
        </v-btn>
        <v-btn label color="lime" large dark >
          Obstertrics and Gynaecology
        </v-btn>
        <v-btn label color="info" large dark >
          Paediatric  
        </v-btn>
        <v-btn label color="error" large dark >
          Physiotherapy
        </v-btn>
        <v-btn label color="light-green" large dark >
          Podiatry
        </v-btn>
        <v-btn label color="info" large dark >
          Pulmonology
        ...
        <v-btn label color="red" large dark >
          Urology
        </v-btn>
        <v-btn label color="green" large dark >
          Health and Wellness
        </v-btn>
        <v-btn label color="light-blue" large dark >
          Mental Health and Behavioural Sciences
        </v-btn>
        <v-btn label color="primary" large dark >
          Dermatology  
        </v-btn>
        <v-btn label color="cyan" large dark >
          Emergency
        </v-btn>
        <v-btn label color=teal large dark >
          Cancer/Oncology
        </v-btn>
        <v-btn label color="indigo" large dark >
          Neurosciences
        </v-btn>
        <v-btn label color="info" large dark >
          Orthopaedics
        </v-btn>
        <v-btn label color="deep-purple" large dark >
